...
export { first, second, restOfList };
...
const numbers1 = [3, 2, 3, 2, 1, 2, 3, 4];

function add(...allNumbers1) {
  return allNumbers1.reduce?.((a, b) => a + b, 0);
}

export const sum = add(...numbers1);
console.log(sum);
/*
EXERCISE 4
